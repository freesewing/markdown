...
that you should join. Not that the group is private, so you should request access, but that's
...
Our Twitter account is [@freesewing_org](https://twitter.com/freesewing_org).
Follow us for updates on new pattern releases, makes from the community, and other news.

###### YouTube

Make sure to subscribe to [the FreeSewing YouTube channel](https://youtube.com/channel/UCLAyxEL72gHvuKBpa-GmCvQ)
for our in-depth tutorials that walk you through our patterns.

###### Zoom

We hold regular calls with contributors via Zoom. Anyone is free to join via https://meet.freesewing.org.
Please refer to [our planning](#planning) for upcoming Zoom calls.
