...
The `preRender` hook is triggered just before your pattern is rendered to SVG. Your hook method will receive [the SVG object](/en/docs/developer/api/svg) as its first parameter.
